...
#
AUDIO_PATTERNS_2 := @SOUND_CARD_NAME@=floridaaudio
...
include $(CLEAR_VARS)
LOCAL_MODULE := AudioParameterFramework-wm8281$(TUNING_SUFFIX).xml
LOCAL_MODULE_STEM := AudioParameterFramework-wm8281.xml
ifeq ($(BOARD_HAVE_MODE),true)
LOCAL_SRC_FILES := $(LOCAL_MODULE_STEM).in
else
LOCAL_SRC_FILES := AudioParameterFramework-wm8281-nomodem.xml.in
endif
...
include $(CLEAR_VARS)
LOCAL_MODULE := RouteParameterFramework-wm8281$(TUNING_SUFFIX).xml
LOCAL_MODULE_STEM := RouteParameterFramework-wm8281.xml
LOCAL_SRC_FILES := $(LOCAL_MODULE_STEM).in
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_PROPRIETARY_MODULE := true
...
include $(CLEAR_VARS)
LOCAL_MODULE := AudioConfigurableDomains-wm8281.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_PROPRIETARY_MODULE := true
...
LOCAL_ADDITIONAL_DEPENDENCIES := \
    $(TARGET_OUT_VENDOR_ETC)/parameter-framework/AudioParameterFramework-wm8281$(TUNING_SUFFIX).xml \
    $(TARGET_OUT_VENDOR_ETC)/parameter-framework/Structure/Audio/AudioClass-wm8281.xml \
    $(TARGET_OUT_VENDOR_ETC)/parameter-framework/Structure/Audio/SstSubsystem-wm8281.xml \
    $(TARGET_OUT_VENDOR_ETC)/parameter-framework/Structure/Audio/WM8281Subsystem.xml \
...
PFW_TOPLEVEL_FILE := $(TARGET_OUT_VENDOR_ETC)/parameter-framework/AudioParameterFramework-wm8281.xml
PFW_CRITERIA_FILE := $(COMMON_PFW_CONFIG_PATH)/AudioCriteria.txt
ifeq ($(BOARD_HAVE_MODE),true)
PFW_TUNING_FILE := $(LOCAL_PATH)/Settings/Audio/AudioConfigurableDomains-wm8281.Tuning.xml
PFW_EDD_FILES := \
    $(PLATFORM_PFW_CONFIG_PATH)/Settings/Audio/routing_hwcodec_common_wm8281.pfw \
...
PFW_TUNING_FILE := $(LOCAL_PATH)/Settings/Audio/AudioConfigurableDomains-wm8281-nomodem.Tuning.xml
PFW_EDD_FILES := \
    $(PLATFORM_PFW_CONFIG_PATH)/Settings/Audio/routing_hwcodec_common_wm8281.pfw \
    $(PLATFORM_PFW_CONFIG_PATH)/Settings/Audio/routing_sst_common.pfw \
    $(COMMON_PFW_CONFIG_PATH)/Settings/Audio/routing_power.pfw \
...
include $(CLEAR_VARS)
LOCAL_MODULE := RouteClass-wm8281.xml
...
include $(CLEAR_VARS)
LOCAL_MODULE := RouteConfigurableDomains-wm8281.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_PROPRIETARY_MODULE := true
...
# Refresh domain file
LOCAL_ADDITIONAL_DEPENDENCIES := \
        $(TARGET_OUT_VENDOR_ETC)/parameter-framework/RouteParameterFramework-wm8281$(TUNING_SUFFIX).xml \
        $(TARGET_OUT_VENDOR_ETC)/parameter-framework/Structure/Route/RouteClass-wm8281.xml

PFW_TOPLEVEL_FILE := $(TARGET_OUT_VENDOR_ETC)/parameter-framework/RouteParameterFramework-wm8281.xml
...
include $(CLEAR_VARS)
LOCAL_MODULE := AudioClass-wm8281.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_RELATIVE_PATH := parameter-framework/Structure/Audio
ifeq ($(BOARD_HAVE_MODEM),true)
LOCAL_SRC_FILES := Structure/Audio/AudioClass-wm8281.xml
else
LOCAL_SRC_FILES := Structure/Audio/AudioClass-wm8281-nomodem.xml
endif
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := WM8281Subsystem.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_RELATIVE_PATH := parameter-framework/Structure/Audio
...
include $(CLEAR_VARS)
LOCAL_MODULE := SstSubsystem-wm8281.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_RELATIVE_PATH := parameter-framework/Structure/Audio
