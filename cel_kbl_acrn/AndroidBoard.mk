...
##############################################################
# Source: device/intel/mixins/groups/device-specific/cel_kbl_acrn/AndroidBoard.mk
##############################################################
...
##############################################################
# Source: device/intel/mixins/groups/variants/true/AndroidBoard.mk
##############################################################
...
##############################################################
# Source: device/intel/mixins/groups/boot-arch/vsbl/AndroidBoard.mk
##############################################################
...
.PHONY: bootloader
##############################################################
# Source: device/intel/mixins/groups/wlan/mwifiex/AndroidBoard.mk
##############################################################
...
include $(BUILD_PHONY_PACKAGE)
##############################################################
# Source: device/intel/mixins/groups/audio/gordon_peak_acrn/AndroidBoard.mk
##############################################################
USE_CUSTOM_PARAMETER_FRAMEWORK=true
##############################################################
# Source: device/intel/mixins/groups/acrn-guest/true/AndroidBoard.mk.1
##############################################################
######################################################################
...
$(ACRN_GPTIMAGE_BIN): \
	...
	$(INTEL_PATH_BUILD)/create_gpt_image.py \
		...
		--factory $(raw_factory)
##############################################################
# Source: device/intel/mixins/groups/acrn-guest/true/AndroidBoard.mk
##############################################################
######################################################################
...
######################################################################
# Generate ACRN E2E flashfiles *.tar.gz
######################################################################
