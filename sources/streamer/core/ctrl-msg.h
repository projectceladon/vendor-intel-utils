...
struct ctrlmsg_system_netreport_s {
    ...
    unsigned int bytecount;        /*< total received amount of data (in bytes) */
...
#ifdef WIN32
BEGIN_CTRL_MESSAGE_STRUCT
struct ctrlmsg_system_netreport_delay_s {
    unsigned short msgsize;        /*< size of this message, including this field */
    unsigned char msgtype;        /*< must be CTRL_MSGTYPE_SYSTEM */
    unsigned char subtype;        /*< must be CTRL_MSGSYS_SUBTYPE_NETREPORT */
    unsigned int magic;            /*< must be 0xde1a*/
    unsigned int first_delay;            /*< delay of the first pkt (in microseconds) */
    unsigned int last_delay;    /*< delay of the last pkt */
    unsigned int estimated_bw;    /*< estimated bandwidth (in kbps) */
    unsigned int frame_number;    /*< frame number from last report */
    unsigned int pad;
}
END_CTRL_MESSAGE_STRUCT
typedef struct ctrlmsg_system_netreport_delay_s ctrlmsg_system_netreport_delay_t;
#endif
////////////////////////////////////////////////////////////////////////////
...
#ifdef WIN32
EXPORT ctrlmsg_t * ctrlsys_netreport_delay(ctrlmsg_t *msg, double first, double last, double bw);
#endif
