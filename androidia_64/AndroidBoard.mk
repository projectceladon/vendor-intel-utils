...
TARGET_KERNEL_SRC ?= device/android_ia/kernel

TARGET_KERNEL_ARCH := x86_64
KERNEL_NAME := bzImage
TARGET_KERNEL_CONFIG ?= kernel_64_defconfig
KERNEL_CONFIG_DIR ?= device/android_ia/kernel_config
...
ADDITIONAL_DEFAULT_PROPERTIES += ro.boot.moduleslocation=$(KERNEL_MODULES_INSTALL)/$(KERNEL_VERSION)-android_ia_64+/
...
KERNEL_CONFIG_FILE := $(KERNEL_CONFIG_DIR)/$(TARGET_KERNEL_CONFIG)
